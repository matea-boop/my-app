...
export const EVENT_NOT_EDITED = "EVENT_NOT_EDITED";

export const EVENT_DELETED = "EVENT_DELETED";
export const EVENT_NOT_DELETED = "EVENT_NOT_NOT_DELETED";
...
export const DEADLINE_EDITED = "DEADLINE_EDITED";
export const DEADLINE_NOT_EDITED = "DEADLINE_NOT_EDITED";

export const DEADLINE_DELETED = "DEADLINE_DELETED";
export const DEADLINE_NOT_DELETED = "DEADLINE_NOT_DELETED";
